...
double A2StarterAudioProcessor::getTailLengthSeconds() const { return 0.0; }
...
int A2StarterAudioProcessor::getCurrentProgram() { return 0; }
...
void A2StarterAudioProcessor::changeProgramName(int index,
                                                const juce::String &newName) {}

//==============================================================================
void A2StarterAudioProcessor::prepareToPlay(double sampleRate,
                                            int samplesPerBlock) {
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool A2StarterAudioProcessor::isBusesLayoutSupported(
...
void A2StarterAudioProcessor::processBlock(juce::AudioBuffer<float> &buffer,
...
void A2StarterAudioProcessor::setStateInformation(const void *data,
                                                  int sizeInBytes) {
